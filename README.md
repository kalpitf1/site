# Kalpit's personal website

[![Netlify Status](https://api.netlify.com/api/v1/badges/61cef468-7f34-45fe-bb20-5d051736382f/deploy-status)](https://app.netlify.com/sites/kalpitf/deploys)

This is the source for my personal website ([kalpitf.netlify.app](https://kalpitf.netlify.app)). It's built with [Astro](https://astro.build), and uses [TinaCMS](https://tina.io) to edit the content!

Site template by [cassidoo](https://cassidoo.co).
